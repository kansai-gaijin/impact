...
add_action('theme/index/post/thumbnail', 'Impact\Theme\App\Structure\render_post_thumbnail');
...
add_action('theme/index/content/none', 'Impact\Theme\App\Structure\render_empty_content');
...
add_action('theme/single/content', 'Impact\Theme\App\Structure\render_post_content');
...
add_action('theme/page/content', 'Impact\Theme\App\Structure\render_page_content');
...
add_action('theme/index/sidebar', 'Impact\Theme\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'Impact\Theme\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'Impact\Theme\App\Structure\render_documentation_button');
