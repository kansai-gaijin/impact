...
namespace Impact\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Impact\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Impact\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Impact\Theme\App\Setup\modify_excerpt_length');
